...
import { EmployeePhotos } from "../assets/photos"; // Imports the asset map
...
// Node UI (uses ID to conditionally show photo)
...
    .toUpperCase();
  ...
  // Logic checks for the photo using the ID
...
            borderRadius: "10px",
            background: "#fff",
            boxShadow: "0 2 inscrição 6px rgba(0,0,0,0.1)",
          }}
        >
          <div
            style={{
...
          }}
        >
        {/* CONDITIONAL LOGIC FOR PHOTO/INITIALS */}
        {hasPhoto ? (
          // ⭐️ CHANGES HERE for alignment and showing title 
          <div style={{ textAlign: "center" }}>
            <img 
              ...
              style={{
                ...
                marginBottom: "8px",
                display: "block", // Ensure image is a block element for reliable centering
            ...
            <div style={{ fontSize: "0.75rem" }}>{title}</div> {/* ⭐️ ADDED: Display Title/Designation */}
          </div>
        ) : (
          ...
          <>
            ...
            <div style={{ fontSize: "0.85rem", fontWeight: 600 }}>{name}</div>
            <div style={{ fontSize: "0.75rem" }}>{title}</div> {/* Display title even without photo */}
          </>
        )}
        </div>
      </div>
